...
/**
 * Strings for component 'tool_certificate', language 'zh_cn', version '4.1'.
 *
...
$string['entitycertificateissues'] = '颁布证书';
...
$string['issuenewcertificates'] = '颁发新证书';
...
$string['outcomecertificate'] = '颁发证书';
$string['outcomecertificatedescription'] = '颁发证书 \'{$a}\' 给用户';
$string['page'] = '第 {$a} 页';
...
$string['toomanycertificatestoshow'] = '太多证书 ({$a}) 以至于无法显示';
$string['type'] = '类型';
