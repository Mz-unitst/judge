...
/**
 * Strings for component 'theme_adaptable', language 'zh_cn', version '4.1'.
 *
...
$string['alertaccess'] = '提示可见性';
$string['alertaccessadmins'] = '管理员可见';
$string['alertaccessdesc'] = '设置提示框可见性访问限制类型。注意：如果使用“添加自定义配置字段限制”，则需要在下面添加配置字段值。';
...
$string['alertcolorsheadingdesc'] = '设置颜色和图标。';
...
$string['alertdesc'] = '输入及自定义要在站点顶部显示的提示文字。可针对不同的用户类型设置多条提示信息。 可设置多个警报以定位不同的用户类型。您还可以选择在全站或仅在主页上显示提示信息。 <br /> <br /> <strong>注意：</strong>现在还可以在课程页面中显示提示信息，提醒教师课程处于隐藏状态。';
$string['alertdisabled'] = '已禁用';
$string['alertdisabledesc'] = '禁用此提示。';
$string['alerthiddencourse'] = '课程隐藏警告';
$string['alerthiddencoursedesc'] = '如果课程被隐藏，在课程页面中显示提示信息';
$string['alerthiddencoursetext-1'] = '本课程被隐藏，学生无法访问。';
$string['alerthiddencoursetext-2'] = '单击此处更新设置';
$string['alerticoninfo'] = '信息图标';
$string['alerticoninfodesc'] = '设置要在信息类型消息框中使用的<a href="http://fortawesome.github.io/Font-Awesome/icons/">Font Awesome图标</a>。请输入不带fa前缀的图标名称。';
$string['alerticonsuccess'] = '公告图标';
$string['alerticonsuccessdesc'] = '设置要在公告类型消息框中使用的<a href="http://fortawesome.github.io/Font-Awesome/icons/">Font Awesome图标</a>。请输入不带fa前缀的图标名称。';
$string['alerticonwarning'] = '警告图标';
$string['alerticonwarningdesc'] = '设置要在警告类型消息框中使用的<a href="http://fortawesome.github.io/Font-Awesome/icons/">Font Awesome图标</a>。请输入不带fa前缀的图标名称。';
$string['alertinfo'] = '信息';
$string['alertinfodesc'] = '在提示框中显示信息。';
$string['alertkeyvalue'] = '提示信息标识';
$string['alertkeyvalue_details'] = '上一条提示信息的标识。如果更改此值，则之前已取消该提示信息的所有用户将再次看到该条提示信息。如果更改了该条提示信息，您应该同时更改此标识以确保所有用户都能看到它。';
$string['alertprofilefield'] = '自定义配置字段名称=值（可选）';
$string['alertprofilefielddesc'] = '添加使用自定义配置字段问规则，例如：usertype = student';
$string['alertsettings'] = '提示框 {$a}';
$string['alertsettingscourse'] = '课程提示设置';
$string['alertsettingsgeneral'] = '常规提示设置';
$string['alertsettingsheading'] = '自定义顶部提示框。查看<a href="./../theme/adaptable/pix/layout.png" target="_blank">此处</a>的布局';
$string['alerttext'] = '提示文字';
$string['alerttextdesc'] = '提示框输入要在“提示框”中显示的文本';
$string['alerttype'] = '提示框类型';
$string['alerttypedesc'] = '选择提示类型：信息（蓝色），警告（黄色）或通告（绿色）';
$string['alertwarning'] = '警告';
$string['alertwarningdesc'] = '在提示框中显示警告。';
$string['analyticscount'] = '分析计数';
$string['analyticscountdesc'] = '下面编辑区域中显示的分析字段条数。';
$string['analyticsprofilefield'] = '自定义配置字段名称=值（可选）';
$string['analyticsprofilefielddesc'] = '添加使用自定义配置字段问规则，例如：usertype = student';
...
$string['anonymizegadesc'] = '将发送到Google Analytics的用户IP匿名';
$string['backcolor'] = '背景颜色';
$string['backcolordesc'] = '设置背景颜色。';
$string['bcustyle'] = 'BCU风格';
$string['beta'] = '开发中版本。请勿在生产环境使用';
...
$string['breadcrumbseparatordesc'] = '设置用于线索区项目分隔符的<a href="https://fortawesome.github.io/Font-Awesome/icons/" target="_blank">Font Awesome Icon</a> 图标。请输入不带fa-前缀的图标名称。';
...
$string['customcssjssettings'] = '自定义 CSS 及 JS';
...
$string['deprecated'] = '已过时的Moodle版本。请勿在本网站Adaptable主题';
...
$string['enablemyhomedesc'] = '显示指向 {$a} 的链接';
...
$string['frontpagealertsettings'] = '提示框';
$string['frontpageblockregionsettings'] = '版块区域生成器';
...
$string['frontpagetickersettings'] = '首页滚动';
$string['fullscreen'] = '全屏';
$string['fullscreenwidth'] = '全屏宽度。';
$string['fullscreenwidthdesc'] = '设置主题在全屏模式/缩放时的最大宽度。';
$string['genericsettingsdescription'] = '在此处, 您可以找到各种设置, 将自己的 CSS 和 JavaScript 代码添加到主题中。';
$string['genericsettingsheading'] = '应用您自己的修改';
...
$string['menuhovercolor'] = '主菜单鼠标悬停颜色';
$string['menuhovercolordesc'] = '设置主菜单鼠标悬停颜色';
...
$string['msgbadgecolor'] = '消息徽章背景颜色';
$string['msgbadgecolordesc'] = '设置标题区(显示未读信息数量)中消息徽章/气泡的背景颜色';
$string['myblogs'] = '我的博客';
...
$string['navbardisplaysubmenuarrow'] = '显示子菜单箭头';
$string['navbardisplaysubmenuarrowdesc'] = '当菜单标题有子菜单选项时, 显示子菜单箭头 (朝下)。';
...
$string['navbardropdowntransitiontime'] = '导航栏纳动画过渡时间';
$string['navbardropdowntransitiontimedesc'] = '导航栏过渡效果时间 (以秒为单位)。将鼠标悬停在具有子菜单的菜单上时, 提供淡出的动画效果。';
$string['navbarmenusettings'] = '导航栏工具菜单';
$string['navbarmenusettingsdesc'] = '允许向导航栏中添加菜单。';
$string['navbarmenusettingsheading'] = '处定义导航栏中的菜单。 请在<a href="./../theme/adaptable/pix/layout.png" target="_blank"> 此</a>查看布局。';
$string['navbarsettings'] = '标题导航栏';
$string['navbarsettingsheading'] = '自定义导航栏';
$string['newmenu'] = '顶部菜单下拉菜单';
$string['newmenu1trigger'] = '顶部下拉菜单1触发字';
$string['newmenu1triggerdesc'] = '设置顶部菜单下拉菜单1触发字。要使用 Font awesome 图标。';
$string['newmenu2triggerdesc'] = '设置顶部菜单下拉菜单2触发字。要使用 Font awesome 图标。';
...
$string['socialwallactionlinkcolor'] = '操作链接颜色';
$string['socialwallactionlinkcolordesc'] = '社交墙中动作链接的颜色。';
$string['socialwallactionlinkhovercolor'] = '动作链接悬停颜色';
$string['socialwallactionlinkhovercolordesc'] = '社交墙中动作链接的鼠标悬停颜色。';
$string['socialwallbackgroundcolor'] = '背景颜色';
$string['socialwallbackgroundcolordesc'] = '社交墙课程的背景颜色。';
$string['socialwallbordercolor'] = '边框颜色';
$string['socialwallbordercolordesc'] = '社交墙版块的边框颜色。';
