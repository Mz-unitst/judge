...
static 	$DB_PASS="DYR6fJXYlwn4I0aH";  //数据库密码

static 	$OJ_NAME="OJ";  //左上角显示的系统名称
static 	$OJ_HOME="./";    //主页目录
...
}   // APPENDCODE模式需要允许javascript操作cookie保存当前语言。
@session_start();
...
static  $OJ_BEIAN="浙ICP备2021034317号-1";  // 如果有备案号，填写备案号
