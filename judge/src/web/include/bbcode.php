...
class BBCode
{
    ...
    private static function decode_tag($input): array
    {
    ...
    private static function encode($input): string
    {
        return $input;
    ...
    public static function bbcode_to_html($input): string
    {
        global $MSG_TOTAL;
...
function bbcode_to_html($input): string
{
    ...
    if (isset($OJ_DIV_FILTER)&&$OJ_DIV_FILTER) {
        $input=filterDIV($input);
    }
