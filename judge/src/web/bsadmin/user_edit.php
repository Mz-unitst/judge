...
<body>
	...
	?>
                                ...
                                <input type="hidden" name="chsss" value="chsss">
								    ...
								    昵称：
								    <input type="text" class="form-control" name="nick" value="<?php echo $nick;?>"<?php if ($isadmin == 1) {
								        echo " readonly";
								    }?>>
								    密码：
								    <input type="text" class="form-control" name="password" placeholder="谨慎操作！请勿随意修改"<?php if ($isadmin == 1) {
								        echo " readonly";
								    }?>>
								    邮箱：
								    <input type="email" class="form-control" name="email" value="<?php echo htmlentities($email, ENT_QUOTES, "UTF-8")?>"<?php if ($isadmin == 1) {
								        echo " readonly";
								    }?>>
								    学校
								    <input type="text" class="form-control" name="nick" value="<?php echo $school;?>"<?php if ($isadmin == 1) {
								        echo " readonly";
								    }?>>
