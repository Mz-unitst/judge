...
if ($row['upid'] % $page_cnt == 0) {
    $cnt = $cnt-1;
}
if ($page > $cnt+1 && ! isset($_SESSION[$OJ_NAME.'_administrator'])) {
    $page = $cnt+1 ;
}
...
if (isset($_GET['search']) && trim($_GET['search'])!="") {
    ...
    $pstart = 0;
    $pend = 100;
} elseif (isset($_GET['list']) && trim($_GET['list']!="")) {
...
} elseif (isset($_SESSION[$OJ_NAME.'_'.'administrator'])) {  //all problems
    // Reset Page Count
