...
<div id=center>
<table id=result-tab class="table table-striped content-box-header" align=center width=80%  lay-filter="demo">
<thead>
<tr class='toprow' >
...
<th lay-data="{field:'u9',}" ><?php echo $MSG_SUBMIT_TIME?>
<th class='hidden-xs' lay-data="{field:'u10',}" ><?php echo $MSG_JUDGER?>
</tr>
</thead>
<tbody>
<?php
