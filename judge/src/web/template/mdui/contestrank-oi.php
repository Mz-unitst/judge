...
<head>
    <?php $page_title = "OI排名 - ".$cid.": ".$row['title']; ?>
...
for ($i=0; $i<$user_cnt; $i++) {
    ...
    for ($j=0; $j<$pid_cnt; $j++) {
        ...
        } elseif (isset($U[$i]->p_wa_num[$j]) && $U[$i]->p_wa_num[$j]>0) {
        ...
        if (isset($U[$i])) {
            ...
            } elseif (isset($U[$i]->p_wa_num[$j]) && intval($U[$i]->p_wa_num[$j])>0 && isset($U[$i]->p_pass_rate[$j])) {
