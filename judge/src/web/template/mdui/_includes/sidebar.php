<div class="mdui-drawer" id="main-drawer">
    <div class="mdui-list mdui-m-t-1 mdui-color-white">
        <!-- Menu -->
        <a class="mdui-list-item mdui-ripple <?php if (!$url || strpos($url, "index.php") !== false) {
            echo "mdui-list-item-active";
        } ?>"
            href="<?php echo $path_fix; ?>index.php">
            <i class="mdui-list-item-icon mdui-icon material-icons">home</i>
            <div class="mdui-list-item-content">首页</div>
        </a>
        <a class="mdui-list-item mdui-ripple <?php if (strpos($url, "problemset.php") !== false || strpos($url, "problem.php") !== false) {
            echo "mdui-list-item-active";
        } ?>"
        ...
        <a class="mdui-list-item mdui-ripple <?php if (strpos($url, "category.php") !== false) {
            echo "mdui-list-item-active";
        } ?>"
        ...
        <a class="mdui-list-item mdui-ripple <?php if (strpos($url, "status.php") !== false && strpos($url, "status.php?user_id=$sid") === false) {
            echo "mdui-list-item-active";
        } ?>"
        ...
        <a class="mdui-list-item mdui-ripple <?php if (strpos($url, "contest.php") !== false && $url !== "contest.php?my") {
            echo "mdui-list-item-active";
        } ?>"
        ...
        <a class="mdui-list-item mdui-ripple <?php if (strpos($url, "ranklist.php") !== false) {
            echo "mdui-list-item-active";
        } ?>"
        ...
        if (isset($_SESSION[$OJ_NAME.'_'.'user_id'])) {
            ...
            <a class="mdui-list-item mdui-ripple <?php if (strpos($url, "status.php?user_id=$sid") !== false) {
                echo "mdui-list-item-active";
            } ?>"
            ...
            <a class="mdui-list-item mdui-ripple <?php if ($url === "contest.php?my") {
                echo "mdui-list-item-active";
            } ?>"
            ...
            <?php } ?>
        <?php } else { ?>
            <a class="mdui-list-item mdui-ripple <?php if ($url == "loginpage.php") {
                echo "mdui-list-item-active";
            } ?>"
            ...
            <?php if (isset($OJ_REGISTER) && $OJ_REGISTER) { ?>
                <a class="mdui-list-item mdui-ripple <?php if ($url == "registerpage.php") {
                    echo "mdui-list-item-active";
                } ?>"
