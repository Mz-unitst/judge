...
if (isset($_POST['update_solution'])) {
...
} elseif (isset($_POST['getsolutioninfo'])) {
    $sid=intval($_POST['sid']);
...
} elseif (isset($_POST['getsolution'])) {
    $sid=intval($_POST['sid']);
...
} elseif (isset($_POST['getcustominput'])) {
    $sid=intval($_POST['sid']);
...
} elseif (isset($_POST['getprobleminfo'])) {
    ...
    pdo_query($sql, $user_id, $user_id);
//	echo $sql;
} elseif (isset($_POST['updateproblem'])) {
...
} elseif (isset($_POST['checklogin'])) {
    echo "1";
} elseif (isset($_POST['gettestdatalist'])) {
    $pid=intval($_POST['pid']);
...
} elseif (isset($_POST['gettestdata'])) {
    $file=$_POST['filename'];
    if ($OJ_SAE) {
        $store = new SaeStorage();
