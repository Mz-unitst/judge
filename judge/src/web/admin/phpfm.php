...
if (isset($_GET['generate'])) {
    ...
    if (file_exists($current_dir."/Main.c")) {
        if (!$OJ_SaaS_ENABLE) {
            system("/home/judge/src/install/gcc.sh $current_dir");
        }
        system("/home/judge/src/install/makeout.sh Main");
    } elseif (file_exists($current_dir."/Main.cc")) {
        if (!$OJ_SaaS_ENABLE) {
            system("/home/judge/src/install/g++.sh $current_dir");
        }
        system("/home/judge/src/install/makeout.sh Main");
    } else {
...
function dir_list_form()
{
    ...
    if ($opdir = @opendir($current_dir)) {
        ...
        if (!$OJ_SaaS_ENABLE) {
            $out.="<input type=button onclick=\"generate()\" value=\"".et('GenerateOut')."\">";
        }
