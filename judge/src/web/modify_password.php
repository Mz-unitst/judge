...
} elseif (strcmp($_POST['new1-password'], $_POST['new2-password'])!=0) {
...
if (strlen($_POST['new1-password'])==0) {
    $password=pwGen($_POST['old-password']);
} else {
    $password=pwGen($_POST['new1-password']);
}
